...
public class PlaceListAdapter extends RecyclerView.Adapter<PlaceListAdapter.PlaceViewHolder> {
    ...
    public void onBindViewHolder(PlaceViewHolder holder, int position) {
        ...
        String name = placeBuffer.get(position).getName().toString();
        String address = placeBuffer.get(position).getAddress().toString();
    ...
    public void swapPlaces(PlaceBuffer place){
        this.placeBuffer = place;
    ...
    public int getItemCount() {
        ...
        return placeBuffer != null ? placeBuffer.getCount() : 0;
    }
